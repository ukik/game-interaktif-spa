<template>
  <div class=" q-gutter-md">
    ...
    <div>
      ...
      <q-input v-model="form_tugas_create.deskripsi" label="Deskripsi" input-style="min-height: 100px;" type="textarea"
    ...
    <div>
      ...
      <q-input v-model="form_tugas_create.catatan" label="Catatan" input-style="min-height: 100px;" type="textarea"
    ...
    <div class="q-mb-lg">
      ...
      <q-select v-model="form_tugas_create.tugas_kategori" :options="tugas_kategori_options" option-label="nama"
    ...
    <div>
      ...
      <q-field label="Prioritas" stack-label :model-value="form_tugas_create.priority" hide-bottom-space
    ...
    <!-- <div>
      ...
      <q-field label="Visibilitas" stack-label :model-value="form_tugas_create.visibility" hide-bottom-space
        :rules="[val => !!val || 'Status wajib dipilih']" borderless no-error-icon>
          ...
          <q-input outlined v-model="form_tugas_create.begin_date" label="Mulai" placeholder="YYYY-MM-DD"
            ...
            <template v-slot:append>
              <q-icon name="event" class="cursor-pointer">
                <q-popup-proxy cover>
                  <q-date v-model="form_tugas_create.begin_date" mask="YYYY-MM-DD" today-btn :options="disablePast">
        ...
        <div class="col">
          <q-input outlined v-model="form_tugas_create.end_date" label="Selesai" placeholder="YYYY-MM-DD"
            ...
            <template v-slot:append>
              <q-icon name="event" class="cursor-pointer">
                <q-popup-proxy cover>
                  <q-date v-model="form_tugas_create.end_date" mask="YYYY-MM-DD" today-btn :options="disableEndDate">
                    <div class="row justify-end">
                      <q-btn flat label="Close" v-close-popup />
                    </div>
                  </q-date>
    ...
    <div class="row">
      ...
      <q-file class="col-12" v-model="form_tugas_create.image" label="Upload Gambar" accept=".jpg,.png,.jpeg,.webp"
        outlined />
