...
import DeadlineTable from "./components/DeadlineTable.vue";
import RecentSubmissionTable from "./components/RecentSubmissionTable.vue";
import AktivitasNewestTable from "./components/AktivitasNewestTable.vue";
import ContentGrowthTable from "./components/ContentGrowthTable.vue";
import PublishStatusTable from "./components/PublishStatusTable.vue";
import TopMapelTable from "./components/TopMapelTable.vue";
import RoleDistributionTable from "./components/RoleDistributionTable.vue";
import ScoreQuizDistributionTable from "./components/ScoreQuizDistributionTable.vue";
import ScoreModulDistributionTable from "./components/ScoreModulDistributionTable.vue";
import TopKelasTable from "./components/TopKelasTable.vue";
import QuizCategoryTable from "./components/QuizCategoryTable.vue";
import ModulCategoryTable from "./components/ModulCategoryTable.vue";
import QuizPopulerTable from "./components/QuizPopulerTable.vue";
import ModulPopulerTable from "./components/ModulPopulerTable.vue";
import TopTeacherTable from "./components/TopTeacherTable.vue";
import TopSiswaTable from "./components/TopSiswaTable.vue";
import SubmitProgressTable from "./components/SubmitProgressTable.vue";
import DistribusiTipeTugasTable from "./components/DistribusiTipeTugasTable.vue";
