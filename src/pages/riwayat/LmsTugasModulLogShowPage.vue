...
import { useLmsTugasModulLogStore } from "src/stores/lms/LmsTugasModulLogStore";
...
export default {
  ...
  computed: {
    ...
    ...mapState(useLmsTugasModulLogStore, [
      "get_show_payload",
      "get_init_show",
      "get_show_kelas",
    ]),
  ...
  methods: {
    ...mapActions(useLmsTugasModulLogStore, ["onShow", "onChangePage", "onShowTugas"]),
    onBubbleEvent(val) {
