...
export default {
  ...
  computed: {
    ...
    ...mapState(useLmsTugasModulStatsStore, ["get_show_payload", "get_init_show", "get_show_kelas"]),
  },
  methods: {
    ...mapActions(useAuthStore, ["onLogout"]),
    ...mapActions(useLmsTugasModulStatsStore, ["onShow", "onChangePage", "getNamaKelasList"]),
    onBubbleEvent(val) {
