...
export default {
  ...
  computed: {
    ...
    ...mapState(useLmsTugasQuizStatsStore, ["get_show_payload", "get_init_show", "get_show_kelas"]),
  },
  methods: {
    ...mapActions(useAuthStore, ["onLogout"]),
    ...mapActions(useLmsTugasQuizStatsStore, ["onShow", "onChangePage", "getNamaKelasList"]),
    onBubbleEvent(val) {
