      ...
      <q-form @submit="onSubmit">
        ...
        <q-card-section class="scroll" style="max-height: calc(80vh - 52px - 52px);">
          ...
          <q-select option-value="id" clearable option-label="nama" emit-value map-options
            ...
            @filter="(val, update) => filterFn(val, update, 'optionsKategori', 'get_data_global_list_kategori')"
...
export default {
  ...
  methods: {
    ...
    async onClear() {
      ...
      this.optionsKategori = [...this.get_data_global_list_kategori]
    ...
    onOpen(val) {
      ...
      this['filter'].optionsKategori = [...this.get_data_global_list_kategori]
