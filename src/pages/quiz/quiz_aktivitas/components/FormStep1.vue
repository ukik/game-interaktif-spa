<template>
  <div class="q-gutter-md">
    ...
    <div>
      ...
      <q-input
        v-model="form_tugas_edit.deskripsi"
        label="Deskripsi"
    ...
    <div>
      ...
      <q-input
        v-model="form_tugas_edit.catatan"
        label="Catatan"
        input-style="min-height: 100px;"
        type="textarea"
        outlined
    ...
    <div class="q-mb-lg">
      ...
      <q-select
        v-model="form_tugas_edit.tugas_kategori"
    ...
    <div>
      ...
      <q-field
        label="Prioritas"
        stack-label
        :model-value="form_tugas_edit.priority"
        hide-bottom-space
      ...
      >
        <q-option-group
          v-model="form_tugas_edit.priority"
          :options="[
            { label: 'Low', value: 'low' },
    ...
    <div class="q-mb-lg">
      ...
      <div class="row q-gutter-md">
        ...
        <div class="col-6">
          <q-input
            outlined
            v-model="form_tugas_edit.begin_date"
            label="Mulai"
        ...
        <div class="col">
          <q-input
            outlined
            v-model="form_tugas_edit.end_date"
            label="Selesai"
            placeholder="YYYY-MM-DD"
            hint="required"
            :rules="[
              (val) => !!val || 'wajib diisi',
              (val) =>
                !form_tugas_edit.begin_date ||
                val >= form_tugas_edit.begin_date ||
      ...
      <div class="row col-12 q-col-gutter-sm">
        ...
        <div class="col-12 col-sm-6">
          <q-img
            ...
            @error="form_tugas_edit.url_image = global_url_image"
            :error-src="global_url_image"
            :src="form_tugas_edit?.url_image"
          >
