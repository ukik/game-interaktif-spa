<template>
  <div class="q-gutter-md">
    ...
    <div>
      ...
      <q-input
        v-model="form_tugas_create.judul"
        label="Judul"
        outlined
        hint="required"
    ...
    <div>
      ...
      <q-input
        v-model="form_tugas_create.deskripsi"
        label="Deskripsi"
    ...
    <div>
      ...
      <q-input
        v-model="form_tugas_create.catatan"
        label="Catatan"
        input-style="min-height: 100px;"
        type="textarea"
        outlined
    ...
    <div class="q-mb-lg">
      ...
      <q-select
        v-model="form_tugas_create.tugas_kategori"
        :options="tugas_kategori_options"
        option-label="nama"
        option-value="id"
        emit-value
        map-options
    ...
    <div>
      ...
      <q-field
        label="Prioritas"
        stack-label
        :model-value="form_tugas_create.priority"
        hide-bottom-space
      ...
      >
        <q-option-group
          v-model="form_tugas_create.priority"
          :options="[
            { label: 'Low', value: 'low' },
    ...
    <div class="q-mb-lg">
      ...
      <div class="row q-gutter-md">
        ...
        <div class="col-6">
          <q-input
            outlined
            v-model="form_tugas_create.begin_date"
            label="Mulai"
        ...
        <div class="col">
          <q-input
            outlined
            v-model="form_tugas_create.end_date"
            label="Selesai"
            placeholder="YYYY-MM-DD"
            hint="required"
            :rules="[
              ...
              (val) => /^\d{4}-\d{2}-\d{2}$/.test(val) || 'format YYYY-MM-DD',
              (val) =>
                !form_tugas_create.begin_date ||
                val >= form_tugas_create.begin_date ||
    ...
    <div class="row">
      ...
      <q-file
        class="col-12"
        v-model="form_tugas_create.image"
        label="Upload Gambar"
