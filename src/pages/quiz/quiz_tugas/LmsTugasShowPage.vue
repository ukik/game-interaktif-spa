    ...
    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-7 col-xl-7 col-12">
      ...
      <q-card flat bordered>
        ...
        >
          ...
          <q-tab :key="2" name="tab2" :label="get_show_payload?.model ?? 'MODEL'" />
...
export default {
  ...
  methods: {
    ...
    gotoHasil() {
      ...
      this.$router.push({
        name: `lms_tugas_${this.get_show_payload?.model}_stats_show`?.toLowerCase(),
        params: {
