...
import { useLmsNotificationTugasStore } from "src/stores/lms/LmsNotificationTugasStore";
...
export default {
  ...
  async preFetch({ store, currentRoute }) {
    const preStore = useLmsNotificationTugasStore(store);
  ...
  computed: {
    ...
    ...mapWritableState(useLmsNotificationTugasStore, ["tab", "keyword"]),
    ...mapState(useLmsNotificationTugasStore, [
      // "index",
      // "index_read",
      // "index_unread",
      "get_index_data",
  ...
  methods: {
    ...
    ...mapActions(useLmsNotificationTugasStore, [
      "onIndex",
      "onChangePage",
      "onRead",
      "onDelete",
