...
export const useQuizActionShortAnswerStore = defineStore('QuizActionShortAnswerStore', {
  state: () => ({
    init: {
      edit: true,
      create: true,
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useQuizActionShortAnswerStore, import.meta.hot))
}
