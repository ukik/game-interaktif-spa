...
export const useQuizActionBooleanStore = defineStore('QuizActionBooleanStore', {
  state: () => ({
    init: {
      edit: true,
      create: true,
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useQuizActionBooleanStore, import.meta.hot))
}
